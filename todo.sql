...
INSERT INTO todos (id, title, details, priority, created_at) VALUES (1, 'Wash the car', 'Go to car wash and get it done.', 1, 06/26/17 11:15);
...
SELECT title WHERE completed_at = NOT NULL;
